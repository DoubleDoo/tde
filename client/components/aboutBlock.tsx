        ...
        <Col span={1}></Col>
          <Col xs={{span: 22}} sm={{span: 22}} lg={{span: 16}}>
            <Typography>
              ...
              Вся наша продукция имеет необходимые сертификаты. Предоставляется гарантийное и послегарантийное обслуживание. 
              Имея собственные и партнерские производства в Санкт-Петербурге АО ПО «Электробалт», 
              ООО «Терма Энерго»,ООО «Элтех» г.Чебоксары статус партнеры, и собственные сборочные площадки в 
              г.Чебоксары по сборке БМЗ и ПС. Наш коллектив выполняет как типовые так и не стандартные технические 
              решения по изготовлению Подстанций.
              </Paragraph>
            </Typography>
          </Col>
