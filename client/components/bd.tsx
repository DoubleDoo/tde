...
export const newsList = new Array(
    {
        name: "Выставка 18-22 апреля 2022 «Нефтегаз» в «ЭКСПОЦЕНТРЕ» – главная выставка нефтегазовой отрасли с 1978 года!",
        imglink: "/mainCarousel/2.jpg",
        text: "Выставка «Нефтегаз» входит в десятку крупнейших нефтегазовых смотров мира. Проводится ежегодно вместе с Национальным нефтегазовым форумом. Выставка и форум – это синергия участников, партнеров и всей отрасли, здесь представлены все новейшие разработки, встречаются производители и потребители, звучат трендовые доклады, проводятся самые значимые деловые мероприятия.",
        data: "15.02.2022",
        newsLink: "/news/9"
    },
    {
