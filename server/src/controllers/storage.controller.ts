...
export class StorageController {
  ...
  @Get(':uuid')
  @ApiOperation({ summary: 'Get storage entity by id' })
  @ApiResponse({ status: 403, description: 'Forbidden' })
  @ApiResponse({ status: 400, description: 'Bad Request' })
  @HttpCode(200)
  public async find(@Param('uuid', new ParseUUIDPipe()) id: string): Promise<Storage> {
    return await this.service.find(id);
  }


  @Get()
  @ApiOperation({ summary: 'Get list of all storage entities' })
  @ApiResponse({ status: 403, description: 'Forbidden' })
  @ApiResponse({ status: 400, description: 'Bad Request' })
  @HttpCode(200)
  ...
  @Put(':uuid')
  @ApiOperation({ summary: 'Change storage entity by id' })
  @ApiResponse({ status: 403, description: 'Forbidden' })
  @ApiResponse({ status: 400, description: 'Bad Request' })
  @HttpCode(200)
  public async put(@Param('uuid', new ParseUUIDPipe()) id: string, @Body() body: CreateStorageDto): Promise<Storage> {
    return await this.service.put(id, body);
  }


  @Post()
  @ApiOperation({ summary: 'Create storage entity' })
  ...
  public async post(@Body() body: CreateStorageDto, @UploadedFiles() obj: { files?: Express.Multer.File[], images?: Express.Multer.File[] }): Promise<Storage> {
